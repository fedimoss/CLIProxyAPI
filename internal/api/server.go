...
type serverOptionConfig struct {
	...
	postRegisterHook      func(context.Context, *auth.Auth)
...
// WithPostRegisterHook registers a callback after auth is registered in the core manager.
...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		// 用户管理
		mgmt.GET("/users", s.mgmt.ListUsers)
		mgmt.POST("/users", s.mgmt.CreateUser)
		mgmt.PUT("/users", s.mgmt.UpdateUser)
		mgmt.DELETE("/users", s.mgmt.DeleteUser)
	}
}
