...
func TestPatchAuthFileStatusVerifiesAuthIndex(t *testing.T) {
	t.Skip("requires zorm DB persistence (lishuaibo HEAD architecture); the in-memory manager test setup does not initialize zorm, so PatchAuthFileStatus returns 500")
